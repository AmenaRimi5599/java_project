...
class Rim extends JFrame 
{
	...
	public Rim()
	{
		...
		b1.addActionListener(new ButtonSensor(this));
		b2.addActionListener(new ButtonSensor(this));
	}
}
...
public void actionPerformed(ActionEvent ae)
	{    
	    ...
	    if(command=="Rimi")
		{
			System.out.println("Rifat calling");
		}
		if(command=="Ovi")
		{
			System.out.println("Rimi Hate Ovi...So stop ovi");
		}	
	}
}
class Rim1
